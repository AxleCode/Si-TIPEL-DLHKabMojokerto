...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto fs-6" href="#services">Pelayanan</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="w-100 " style="height: 1px">
    <div class="alert bg-warning" style="height: 70px" role="alert">
       <strong><i class="bi bi-exclamation-triangle-fill"></i> Perhatian!</strong> <marquee scrollamount="15"><p style=" font-size: 14pt">Mohon maaf Website masih dalam tahap Pengembangan belum dapat melayani laporan/aduan yang sebenarnya namun silahkan uji coba website kami untuk user experience :D</p></marquee>
  </div>
    </div>
  <main id="main">
