						...
						<div class="card">
                            ...
                            @if(session('swal'))
									...
									<div class="d-flex justify-content-between align-items-center mb-3">
										<h4 class="text-right">Laporan Aduan yang menggunakan kategori {{ $category->name }}</h4>
									</div>

                                <div class="">
                                  <a class="w-30 ms-2 mb-2 btn btn-lg btn-outline-primary" href="/dashboard/kategori" >
